...
def chotot(sdt):
  headers = {
    ...
    # 'content-length': '22',
    'user-agent': 'Mozilla/0.5 (Linux; Android 8.1.0; Redmi 5A Build/OPM1.171019.026) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.5735.130 Mobile Safari/537.36',
...
def run(sdt,i):
  ...
  print(" Attack Sent | Plan : Free | Group : https://t.me/L7_Power",i)
  for j in range(10):
    print(f" TLC GAMER\r",end="")
    time.sleep(1)
