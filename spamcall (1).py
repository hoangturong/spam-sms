...
long_url=(f"https://anhgit.site/key/?key={key}")
api_token='487d6775-92ed-414f-a6f7-089e8a5c935f'
...
if check_file_key == False:
   print(f"{mquang}{luc}Đây Là Tool Free Nên Key Sẽ Thay Đổi Mỗi Ngày !!")
   print(f'{mquang}{luc}Truy Cập Vào Link{trang}: {link} {luc}Để Lấy Key Miễn Phí')
   print(f'{trang}-----------------------------------------------------------------')
   print(f'\033[1;36m╔════════════════════════╗')
   ...
   while(True):
      ...
      if ma == key:
         print(f'{mquang}{luc}API Key Chính Xác')
         luu=open(file_key, 'a+')
         luu.write(ma)
         luu.close()
         break
    ...
    print(f'{mquang}{luc}Đang Lấy Key...',end='\r')
    sleep(1)
    k=open(file_key, 'r')
    ma=k.read()
    k.close()
    if ma == key:
        print(f'{mquang}{luc}Lấy Key Thành Công       ',end='\r')
        sleep(0.5)
    elif ma != key:
