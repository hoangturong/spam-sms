...
░╚════╝░  ░░░╚═╝░░░╚═╝░░╚═╝░░╚═╝╚═╝░░░╚═╝░░░╚══════╝
\033[1;34m╠═════════════════════════════════════════════════════════════════
\033[1;32m║➢ Author   : C WHITE TOOL                                      
\033[1;36m║➢ Youtube  :   https://www.youtube.com/@cwhitetool                   
\033[1;31m║➣ Nhóm Zalo  : https://zalo.me/g/apmxom704                   
\033[1;33m║➣ Facebook   : https://www.facebook.com/cwhitetool                      
\033[1;34m╚═════════════════════════════════════════════════════════════════
  Lưu Ý:
  • Để dừng tấn công bấm [ CTRL + c ] 2 lần
  • Khi chạy tool máy sẽ có cảm giác lag !!!
  • Thắc mắc hoặc cần hỗ trợ liên hệ : C WHITE TOOL
\033[1;31m ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
count = int(input("[ + ] Số Tin Nhắn / Call [ Bao Nhiêu Cũng Được ]: "))
if sdt == "0868841846":
  print("SPAM  ")
  exit()
...
def run(sdt,i):                  
  ...
  threading.submit(KILO,sdt)
  threading.submit(GAPO,sdt) 
  print("[ Cwhite TooL ] Spam SMS - Call | Delay : 5 | Trạng Thái : Thành Công ",)  
  for j in range(0, 5):
    # code trong vòng lặp
    print(f"[ Cwhite TooL ] | LOADING \r",end="")
    # code by AwmxBaby
